        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownButton(thingsToDisplay: Category.all, initialText: "Personal", onSelected: (selected) {}),
              const SizedBox(height: 20),
              Text('Priority:', style: Styles.blue18Bold.copyWith(color: Colors.black)),
              const SizedBox(height: 5),
              CustomDropdownButton(thingsToDisplay: Priority.all, initialText: "High", onSelected: (selected) {}),
            ],
          ),
        ),
      ),

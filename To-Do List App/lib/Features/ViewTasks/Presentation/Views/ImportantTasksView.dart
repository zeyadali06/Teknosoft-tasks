...
class ImportantTasksView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingButton(onPop: () => BlocProvider.of<ImportantTasksCubit>(context).getImportantTasks(BlocProvider.of<ImportantTasksCubit>(context).whenRefreshDateTime)),
    );
  }
}

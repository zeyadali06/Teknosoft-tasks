...
abstract class Styles {
  ...
  static const TextStyle blue12Bold = TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 12, color: Color(0xff3759b9));
  ...
  static const TextStyle blue18Bold = TextStyle(fontFamily: 'Lato', fontWeight: FontWeight.bold, fontSize: 18, color: Color(0xff3759b9));
